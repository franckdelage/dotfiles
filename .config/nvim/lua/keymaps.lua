...
-- Tab operations (deprecated - submenu for friction)
vim.keymap.set('n', '<leader>ttc', '<cmd>tabnew<cr>', { desc = 'Tab new' })
vim.keymap.set('n', '<leader>ttd', '<cmd>tabclose<cr>', { desc = 'Tab close' })
vim.keymap.set('n', '<leader>ttl', '<cmd>tabmove -1<cr>', { desc = 'Tab move left' })
vim.keymap.set('n', '<leader>ttr', '<cmd>tabmove +1<cr>', { desc = 'Tab move right' })
